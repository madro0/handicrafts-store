        ...
        <div>
            <section className="newsletter section" id="suscrived">
                <div className="newsletter__container bd-grid">
                    ...
                    <form section="" className="newslettler__form">
                        <input type="text" className="newslettler" placeholder="Enter your email"></input>
                        <a href="#home" className="button">SUSCRIBE</a>
                    </form>
                </div>
            </section>
        </div>
